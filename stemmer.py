...
from vnlp.tokenizer import TreebankWordTokenize
from vnlp.utils import check_and_download, load_keras_tokenizer
from vnlp._melik_utils import create_stemmer_model, process_input_text
...
class StemmerAnalyzer:
    ...
    def __init__(self, evaluate=False):
        ...
        self.model = create_stemmer_model(NUM_MAX_ANALYSIS, STEM_MAX_LEN, CHAR_VOCAB_SIZE, CHAR_EMBED_SIZE,
                                          STEM_RNN_DIM,
    ...
    def predict(self, sentence: str, batch_size: int = 64) -> List[str]:
        ...
        # Tokenizing Input
        X, _ = process_input_text([sentence], self.tokenizer_char, self.tokenizer_tag, STEM_MAX_LEN, TAG_MAX_LEN,
